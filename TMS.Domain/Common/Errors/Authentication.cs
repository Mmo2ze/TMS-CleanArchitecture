...
public static partial class Errors
{
	public static class Auth
	{
		...
		public static Error CodeExpired(DateTime date) => Error.Unauthorized("Auth.CodeExpired", $"Code expired at {date}");
		public static Error UnauthorizedToBeAdmin => Error.Unauthorized("Auth.UnauthorizedTobeAdmin", "You are not authorized to be an admin");
