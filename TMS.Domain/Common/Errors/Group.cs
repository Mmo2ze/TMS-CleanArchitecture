...
public static partial class Errors
{
    public static class Group
    {
        ...
        public static Error GroupNameAlreadyExists =>
            Error.Conflict("Group.NameAlreadyExists", "Group name already exists");
    ...
    public static class Account
    {
        ...
        public static Error AccountNameAlreadyExists =>
            Error.Conflict("Account.NameAlreadyExists", "Account name already exists");
    ...
    public static class Session
    {
        ...
        public static Error SessionShouldBeOnePerDay =>
            Error.Conflict("Session.ShouldBeOnePerDay", "Session should be one per day");
    }
