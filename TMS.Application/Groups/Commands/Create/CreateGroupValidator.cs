...
public class CreateGroupValidator: AbstractValidator<CreateGroupCommand>
{
    ...
    private async Task<bool> BeNotUsed(string arg1, CancellationToken arg2)
    {
        return ! await _groupRepository.AnyAsync(x => x.Name == arg1 && x.TeacherId == _teacherHelper.GetTeacherId(),arg2); 
    }
}